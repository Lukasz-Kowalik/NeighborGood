        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    XCoordination = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    YCoordination = table.Column<string>(type: "nvarchar(max)", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Announcements_Localizations_LocalizationId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Announcements_LocalizationId",
                table: "Announcements",
