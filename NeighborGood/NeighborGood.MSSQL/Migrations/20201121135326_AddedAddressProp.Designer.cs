...
namespace NeighborGood.MSSQL.Migrations
{
    ...
    [Migration("20201121135326_AddedAddressProp")]
    partial class AddedAddressProp
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("NeighborGood.Models.Entity.Tag", b =>
                {
                    ...
                    b.Property<int?>("UserRegisterRequestId")
                        .HasColumnType("int");

                    b.HasKey("Id");

                    b.HasIndex("UserRegisterRequestId");
            ...
            modelBuilder.Entity("NeighborGood.Models.Entity.UserRegisterRequest", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("NeighborGood.Models.Entity.Tag", b =>
                {
                    b.HasOne("NeighborGood.Models.Entity.UserRegisterRequest", null)
                        .WithMany("Tags")
                        .HasForeignKey("UserRegisterRequestId");
                });
